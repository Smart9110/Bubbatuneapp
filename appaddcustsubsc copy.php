...
session_start();
  ...
  $firstname = $_POST['firstname'];
   ...
   if ($baduser == 0)
   {
      $query = "INSERT INTO appsubscribers (date, firstname, lastname, " .
   ...
   } else
   {
      switch($baduser)
      {
       ...
       echo "<a href=\"https://www.bubbatuneapp.com/newcustsubscribers.html\">Try again</a>\n";
   }
  ...
  $firstname = $_POST['firstname'];
   ...
   $query = "SELECT * from appcustomers where email = '$email'";
   $result = mysql_query($query);
   $rows = mysql_num_rows($result);
   ...
   if ($baduser == 0)
   {
      $query = "INSERT INTO appcustomers (date, firstname, lastname, " .
              "email, password) VALUES ('$date', '$firstname', '$lastname' , " .
              "'$email', " .
              " PASSWORD('$password1'))";
      $result=mysql_query($query);
